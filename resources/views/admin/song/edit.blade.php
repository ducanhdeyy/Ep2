...
@section('content')
    ...
    <div class="iq-card-body">
        <x-alert/>
        <form class="form-validate" method="post" action="{{route('song.update',$songg)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label>Song Name:</label>
                <input type="text" name="name" class="form-control" value="{{$songg->name}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" class="form-control" value="{{$songg->price}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <img src="{{url('uploads/img')}}/{{$songg->image_path}}" width="100" height="100" alt="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="introduction" rows="4">{{$songg->introduction}}</textarea>
            </div>
